...
async function generatePDF(data, invNo) {
  ...
  ">
    <!-- Header -->
    <div style="background:#f8f6f2;padding:24px 32px 18px;border-bottom:4px solid #C9A84C;">
      <div style="text-align:center;">
        ...
        <div style="margin-top:12px;padding-top:12px;border-top:1px solid rgba(201,168,76,0.25);">
          <div style="font-size:13px;font-weight:700;color:#202124;margin-bottom:3px;">Khalid Bin Walid</div>
          <div style="font-size:11px;color:#202124;margin-bottom:3px;">Kalibari Road, Sirajganj</div>
          <div style="font-size:11px;color:#202124;">Contact No: 01710979757 || 01710721807</div>
        </div>
      </div>
    ...
    <!-- Total -->
    <div style="margin:14px 24px 0;background:#f8f6f2;
      border:1.5px solid #C9A84C;border-radius:10px;padding:14px 20px;
      display:flex;justify-content:space-between;align-items:center;">
      <span style="font-size:13px;color:#9a7830;font-weight:700;letter-spacing:1px;">মোট / TOTAL AMOUNT</span>
    ...
    <div style="margin:12px 24px 0;padding:12px 16px;background:#f8f6f2;border-radius:8px;
      ...
      <div style="font-size:12px;color:#181818;">${data.note}</div>
    </div>`
        : ""
    }
  ...
  try {
    ...
    const pdfH = (canvas.height * pdfW) / canvas.width; // dynamic height

    const pdf = new jsPDF({
      orientation: pdfH > 297 ? "portrait" : "portrait",
      unit: "mm",
      format: [pdfW, pdfH], // custom height = content height
    });
